var config = {
    ...
    about: "<p>你好！我叫陈雪照，性别男，广西农业职业技术大学大三实习。我期望的工作岗位是Go/Java后端开发。</p>" +
        "<p>我有着较多的Java编程经验，计算机基础知识掌握扎实，能够在工作中很好的完成自己的任务。此外，我有着充满激情的工作态度，团队协同作战能力强，同时我也具备独立开发的能力，擅于发现并解决问题。我的执行力强、责任感高、集体荣誉感强、敢于担当.</p>" +
        "<p>十分期待与您的联系!</p>",
    ...
    */  
    ...
    work: [
        ...
        ["2021/7/1 — 2021/11/30", "<br>JAVA开发工程师",
            "" +
            "<p>1.在项目负责人的指导下,配合完成了公司外包项目的设计,开发等工作;</p>" +
